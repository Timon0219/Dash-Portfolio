    ...
    >
      <div className="flex flex-col gap-3 pl-3 md:gap-5 lg:gap-10">
        ...
        <AnimatedText
          as="p"
          className="text-primary md:text-xl lg:text-2xl xl:text-3xl "
          text={' Senior WordPress Elementor // WooCommerce // Theme Customize'}
